 ...
 *
 * @WeatherApiPlugin(
 *   id="open_weather_map_plugin",
 *   label="OpenWeatherMap",
 *   base_url="https://api.openweathermap.org/data/2.5/weather",
 *   template="open_weather_map_theme",
 * )
 */
class OpenWeatherMap extends WeatherApiPluginBase {
  ...
  public function buildConfigurationForm(array $form, FormStateInterface $form_state) {
    ...
    $form['service_options']['api_key'] = [
      ...
      '#description' => $this->t('You can get API key on account page in the <a href="@weather-service-link">@weather-service service</a>.', [
        '@weather-service-link' => 'https://openweathermap.org/',
        '@weather-service' => $this->t('Open Weather Map'),
      ]),
    ];
    return $form;
  }
